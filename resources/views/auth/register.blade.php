      ...
      <form class="register-page__form"
        ...
        <div class="register-page__form-section">
          ...
          <div class="register-page__form-group form-group">
            <label class="register-page__label form__label" for="name">
              名前
            </label>
            <input class="form__input register-page__input"
              type="text"
              name="name"
              id="name"
              value="{{ old('name') }}"
          ...
          <!-- メールアドレス -->
          <div class="register-page__form-group form-group">
            <label class="register-page__label form__label" for="email">
              メールアドレス
            </label>
            <input class="form__input register-page__input"
              type="email"
          ...
          <!-- パスワード -->
          <div class="register-page__form-group form-group">
            <label class="register-page__label form__label" for="password">
              パスワード
            </label>
            <input class="form__input register-page__input"
              type="password"
          ...
          <!-- 確認用パスワード -->
          <div class="register-page__form-group form-group">
            <label class="register-page__label form__label" for="password_confirmation">
              パスワード確認
            </label>
            <input class="form__input register-page__input"
              type="password"
